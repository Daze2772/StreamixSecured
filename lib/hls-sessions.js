...
// ffprobe on a Real-Debrid CDN URL (with the deep analyze settings we
...
//
// Keyed by sourceUrl (the RD/Comet playback URL). TTL = 30 min — long
// enough for a single watch session, short enough that stale RD URLs
